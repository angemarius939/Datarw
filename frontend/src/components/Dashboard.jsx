      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <CreateProjectModal onProjectCreated={() => {
                  // Refresh data or handle project creation
          ...
          {activeTab === 'reports' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h1 className="text-3xl font-bold text-gray-900">Automated Reporting</h1>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Create and manage templates for automated report generation
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="border-dashed border-2 border-gray-300 hover:border-green-400 transition-colors">
                      <CardContent className="p-6 text-center">
                        ...
                        <p className="text-sm text-gray-600 mb-3">Monthly project progress and KPI reports</p>
                    ...
                    <Card className="border-dashed border-2 border-gray-300 hover:border-blue-400 transition-colors">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="font-medium mb-1">Quarterly Reports</h3>
                        <p className="text-sm text-gray-600 mb-3">Comprehensive quarterly performance reviews</p>
                        <Button variant="outline" size="sm">Create Template</Button>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-dashed border-2 border-gray-300 hover:border-purple-400 transition-colors">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="font-medium mb-1">Annual Reports</h3>
                        <p className="text-sm text-gray-600 mb-3">Yearly comprehensive impact assessments</p>
                        <Button variant="outline" size="sm">Create Template</Button>
                      </CardContent>
                    </Card>
                  </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Download and manage automatically generated reports
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p>Reports will appear here once you create templates and schedule generation</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure export formats and delivery methods
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                      ...
                      <h4 className="font-medium text-sm">PDF Reports</h4>
                      <p className="text-xs text-gray-500">Professional formatted PDFs</p>
                    </div>
                    ...
                    <div className="text-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                      ...
                      <h4 className="font-medium text-sm">Excel Files</h4>
                      <p className="text-xs text-gray-500">Data analysis ready formats</p>
                    </div>
                    ...
                    <div className="text-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                      ...
                      <h4 className="font-medium text-sm">Word Documents</h4>
                      <p className="text-xs text-gray-500">Editable report templates</p>
                    </div>
                    ...
                    <div className="text-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                      ...
                      <h4 className="font-medium text-sm">PowerBI</h4>
                      <p className="text-xs text-gray-500">Interactive dashboards</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
